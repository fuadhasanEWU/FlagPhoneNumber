...
open class FPNTextField: UITextField {
    ...
    private func updateUI() {
        ...
        if let phoneCode = selectedCountry?.phoneCode {
            ...
            var image = UIImage(named: "Polygon 90")
            imageView.image = image
            
            let lineView = UIView()
            lineView.backgroundColor = UIColor(red: 188 / 255, green: 201 / 255, blue: 220 / 255, alpha: 1)
            ...
            emptyView.widthAnchor.constraint(equalToConstant: 1).isActive = true
            
            
            let stackView = UIStackView(arrangedSubviews: [imageView, lineView, emptyView])
            stackView.spacing = 7
            stackView.alignment = .center
            
            phoneCodeTextField.rightView = stackView
        }
